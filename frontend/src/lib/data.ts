...
export const SCHEDULED = [
  { name: "Overdue invoice follow-ups", cadence: "Daily · 9:00 AM", next: "Tomorrow, 9:00 AM", apps: ["Stripe", "Gmail"] as AppName[] },
  { name: "Weekly pipeline report", cadence: "Mondays · 8:00 AM", next: "Mon Jul 20, 8:00 AM", apps: ["HubSpot", "Slack"] as AppName[] },
  { name: "Contract renewal scan", cadence: "Thursdays · 3:00 PM", next: "Thu Jul 23, 3:00 PM", apps: ["Airtable", "Gmail"] as AppName[] },
];
